##############################################################################################################################
# Make sure Chrome is not running and the 'C:\Projects\LoseIt\chrome_profile' directory is deleted before running this script.
##############################################################################################################################
...
profile_path = "C:\\Projects\\LoseIt\\chrome_profile"
...
try:
    ...
    delay = 60  # 60 seconds
    print(f"Please log in to LoseIt manually. Waiting for {delay} seconds...")
